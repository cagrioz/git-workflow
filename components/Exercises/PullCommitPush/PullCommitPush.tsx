...
const supportedGraphCommands = ["add", "pull", "push"];
...
function PullCommitPush({ active, updateScore, reset }: { active: boolean; updateScore: any; reset: boolean }) {
    // Success snackbar
