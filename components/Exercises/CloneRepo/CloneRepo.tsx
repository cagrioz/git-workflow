...
function CloneRepo({ active, updateScore, reset }: { active: boolean; updateScore: any; reset: boolean }) {
    // Success snackbar
    ...
    function addCommand() {
        ...
        if (command == "git clone git-workflow") {
                ...
                {(gitgraph) => {
                    ...
                    executedCommands.forEach((command) => {
                        ...
                        if (message[1] === "clone") {
                            ...
                            master.commit("Clone repository");
