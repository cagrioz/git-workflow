...
const supportedGraphCommands = ["add", "pull", "push", "tag"];
...
function PullStageCommitPushTag({ active, updateScore, reset }: { active: boolean; updateScore: any; reset: boolean }) {
    // Success snackbar
...
export default PullStageCommitPushTag;
